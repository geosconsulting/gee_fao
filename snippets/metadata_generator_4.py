...
def metadata_pre_processing(path_test):
    ...
    writenames = ['id_no', 'area', 'system:time_start', 'level', 'days_in_dk']
    ...
    if os.path.isfile(path_test):
        ...
        with open('metadata.csv', 'wb') as csvfile:
            ...
            list_headers = ['id_no', 'area', 'system:time_start', 'level','days_in_dk']
            ...
            for each_file in new_files:
                ...
                metadata = metadata_generator(gee_file)
                metadata['level'] = level[1]
                if "WANE" in each_file:
                    metadata['area'] = 'WANE'
                elif "EANE" in each_file:
                    metadata['area'] = 'EANE'
                else:
                    metadata['area'] = 'AfNE'
...
def main():
    ...
    #path_or_file = r'Y:\L2\L2_WANE_NPP'
    #path_or_file = r'Y:\L2\L2_WANE_TFRAC'
    #path_or_file = 'Z:\L2\L2_WANE_AETmissing'
    #DA FARE
    path_or_file = r'Z:\L2\L2_EANE_TFRAC'
    #path_or_file = r'Z:\L2\L2_EANE_AET'
    #path_or_file = r'Z:\L2\L2_EANE_NPP'
